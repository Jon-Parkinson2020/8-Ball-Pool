...
public class Ball 
{
	 ...
	 */
	public Ball(double x, double y, double diameter, String col, double initialSpeedX, double initialSpeedY)
	{
		xPosition = x;
		yPosition = y;
		size = diameter;
	...
	{
		setXPosition( getXPosition() + speedX );
    	setYPosition( getYPosition() + speedY );
	}
